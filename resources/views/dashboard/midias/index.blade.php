...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><b>Midias</b></div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="{{ url(ENV('APP_URL')) }}/dashboard/midias" method="get" class="row g-3">
                                <div class="col-10">
                                ...
                                @if (count($list) > 0)
                                    @foreach ($list ?? '' as $item)
                                        <tr>
                                            ...
                                            <td style="width:90px;">{{ date('d/m/Y', strtotime($item->Data)) }}</td>
                                            <td style="width:130px;" class="text-right">
                                                ...
                                                <a href="{{ url(ENV('APP_URL')) }}/dashboard/midias/{{ $item->id }}/delete" class="btn btn-sm btn-danger" data-bs-toggle="tooltip" data-bs-placement="top" title="Excluir"><i class="fas fa-edit"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @else
